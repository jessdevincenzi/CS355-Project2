...
exports.GetAll = function(callback) {
    connection.query('SELECT * FROM Shoppers;',
        function (err, result) {
            if(err) {
                console.log(err);
                callback(true);
...
exports.GetByID = function(ShopperID, callback) {
    console.log(userID);
    var query = 'SELECT * FROM all_shopper_reviews WHERE ShopperID=' + userID;
    console.log(query);
...
exports.Insert = function(account_info, callback) {
    ...
    var dynamic_query = 'INSERT INTO Shoppers (Name, Username, Email, Password) VALUES (' +
        '\'' + account_info.Name + '\', ' +
